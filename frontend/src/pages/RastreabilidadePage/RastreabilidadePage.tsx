              ...
              <tbody>
                {logs.map((log) => (
                  <tr key={log.id}>
                    ...
                    <td>
                      <span className={`${styles.badge} ${styles[`badge_${log.acao.toLowerCase()}`]}`}>
                        {log.acao}
                      </span>
                    </td>
                    <td>
                      <strong>{log.entidade}</strong> ({log.entidadeId})
                    </td>
                    <td className={styles.detailsCell}>{log.detalhes}</td>
                  </tr>
                ))}
              </tbody>
            </table>
